...
class zip
{
	...
	//	zero fill
	char crc_str[4] = {0x00, 0x00, 0x00, 0x00};
	char compressed_size_str[4] = {0x00, 0x00, 0x00, 0x00};
	char uncompressed_size_str[4] = {0x00, 0x00, 0x00, 0x00};
	char file_name_length_str[2] = {0x00, 0x00};
	char extra_field_length_str[2] = {0x00, 0x00};
	char file_comment_length_str[2] = {0x00, 0x00};
	char relative_offset_of_local_header[4] = {0x00, 0x00, 0x00, 0x00};
